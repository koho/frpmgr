...
func (pd *EditProxyDialog) pluginProxyPage() TabPage {
	return TabPage{
		...
		Children: []Widget{
			...
			LineEdit{Visible: Bind("vm.PluginUnixVisible"), Text: Bind("PluginUnixPath")},
			Label{Visible: Bind("vm.PluginStaticVisible"), Text: "本地路径:"},
			LineEdit{Visible: Bind("vm.PluginStaticVisible"), Text: Bind("PluginLocalPath")},
			...
			LineEdit{Visible: Bind("vm.PluginCertVisible"), Text: Bind("PluginCrtPath")},
			Label{Visible: Bind("vm.PluginCertVisible"), Text: "密钥路径:"},
			LineEdit{Visible: Bind("vm.PluginCertVisible"), Text: Bind("PluginKeyPath")},
